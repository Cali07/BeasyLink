...
<template>
  <v-app-bar elevation="1" color="white">
    <v-container class="d-flex align-center justify-space-between">
      <NuxtLink to="/" class="text-h6 font-weight-bold">{{ site.businessName }}</NuxtLink>
      <div class="d-none d-md-flex ga-4 align-center">
        ...
        <v-btn :href="site.telLink" color="primary" size="small" prepend-icon="mdi-phone">Call</v-btn>
      </div>
  ...
  <v-navigation-drawer v-model="drawer" location="right" temporary>
    <v-list>
      ...
      <v-list-item :href="site.telLink">
        <v-list-item-title>Call Now</v-list-item-title>
      </v-list-item>
      <v-list-item :href="site.whatsappLink" target="_blank">
